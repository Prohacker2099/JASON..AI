                ...
                colorConfig
                  .map(function (_a) {
                    ...
                    var key = _a[0],
                      itemConfig = _a[1];
                    var color =
                      ((_b = itemConfig.theme) === null || _b === void 0
                        ? void 0
                        : _b[theme]) || itemConfig.color;
                    return color
                      ? "  --color-".concat(key, ": ").concat(color, ";")
                      : null;
                  })
                  .join("\n"),
                "\n}\n",
...
var ChartTooltipContent = React.forwardRef(function (_a, ref) {
  var active = _a.active,
    ...
    className = _a.className,
    _b = _a.indicator,
    indicator = _b === void 0 ? "dot" : _b,
    _c = _a.hideLabel,
    hideLabel = _c === void 0 ? false : _c,
    _d = _a.hideIndicator,
    hideIndicator = _d === void 0 ? false : _d,
    label = _a.label,
...
var ChartLegendContent = React.forwardRef(function (_a, ref) {
  var className = _a.className,
    ...
    payload = _a.payload,
    _c = _a.verticalAlign,
    verticalAlign = _c === void 0 ? "bottom" : _c,
    nameKey = _a.nameKey;
  var config = useChart().config;
