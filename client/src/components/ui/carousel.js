...
var Carousel = React.forwardRef(function (_a, ref) {
  ...
  var _c = (0, embla_carousel_react_1.default)(
...
var CarouselPrevious = React.forwardRef(function (_a, ref) {
  ...
  var _d = useCarousel(),
    ...
    scrollPrev = _d.scrollPrev,
    canScrollPrev = _d.canScrollPrev;
  return (
    <button_1.Button
      ref={ref}
      variant={variant}
...
var CarouselNext = React.forwardRef(function (_a, ref) {
  ...
  var _d = useCarousel(),
    ...
    canScrollNext = _d.canScrollNext;
  return (
    <button_1.Button
      ref={ref}
      variant={variant}
