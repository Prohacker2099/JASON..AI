...
var SidebarProvider = React.forwardRef(function (_a, ref) {
  ...
  var _d = React.useState(defaultOpen),
    _open = _d[0],
    _setOpen = _d[1];
  ...
  var setOpen = React.useCallback(
    function (value) {
      if (setOpenProp) {
        return setOpenProp === null || setOpenProp === void 0
          ? void 0
      ...
      document.cookie = ""
        .concat(SIDEBAR_COOKIE_NAME, "=")
        .concat(open, "; path=/; max-age=")
        .concat(SIDEBAR_COOKIE_MAX_AGE);
    },
    [setOpenProp, open],
  );
...
var Sidebar = React.forwardRef(function (_a, ref) {
  var _b = _a.side,
    ...
    _c = _a.variant,
    variant = _c === void 0 ? "sidebar" : _c,
    _d = _a.collapsible,
    collapsible = _d === void 0 ? "offcanvas" : _d,
    className = _a.className,
    children = _a.children,
    props = __rest(_a, [
      "side",
  ...
  var _e = useSidebar(),
    isMobile = _e.isMobile,
    state = _e.state,
    openMobile = _e.openMobile,
    setOpenMobile = _e.setOpenMobile;
  if (collapsible === "none") {
    return (
      <div
        className={(0, utils_1.cn)(
  ...
  if (isMobile) {
    return (
      <sheet_1.Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
...
var SidebarMenuAction = React.forwardRef(function (_a, ref) {
  var className = _a.className,
    ...
    asChild = _b === void 0 ? false : _b,
    _c = _a.showOnHover,
    showOnHover = _c === void 0 ? false : _c,
