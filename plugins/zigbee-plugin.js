...
exports.ZigbeePlugin = void 0;
var events_1 = require("events");
var uuid_1 = require("uuid");
var logger_js_1 = require("../server/services/logger.js");
var logger = new logger_js_1.Logger("ZigbeePlugin");
var ZigbeePlugin = /** @class */ (function (_super) {
  __extends(ZigbeePlugin, _super);
  function ZigbeePlugin() {
    var _this = _super.call(this) || this;
    _this.name = "zigbee";
    _this.version = "1.0.0";
    _this.supportedDeviceTypes = [
      "light",
      "switch",
      "sensor",
      "outlet",
   ...
   */
  ZigbeePlugin.prototype.discover = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        try {
          sampleDevices = [
            {
              id: "zigbee-light-".concat((0, uuid_1.v4)().substring(0, 8)),
            ...
            {
              id: "zigbee-sensor-".concat((0, uuid_1.v4)().substring(0, 8)),
            ...
            {
              id: "zigbee-switch-".concat((0, uuid_1.v4)().substring(0, 8)),
          ...
          logger.info(
            "Discovered ".concat(sampleDevices.length, " Zigbee devices"),
          );
   ...
   */
  ZigbeePlugin.prototype.control = function (deviceId, command) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_d) {
        ...
        try {
          ...
          logger.error(
            "Error controlling Zigbee device ".concat(deviceId, ":"),
            error,
          );
          throw error;
        }
   ...
   */
  ZigbeePlugin.prototype.getCapabilities = function (deviceId) {
    return __awaiter(this, void 0, void 0, function () {
      var device;
      return __generator(this, function (_a) {
        device = this.devices.get(deviceId);
   ...
   */
  ZigbeePlugin.prototype.validateCommand = function (deviceId, command) {
    return __awaiter(this, void 0, void 0, function () {
      var device;
      return __generator(this, function (_a) {
        device = this.devices.get(deviceId);
...
exports.ZigbeePlugin = ZigbeePlugin;
